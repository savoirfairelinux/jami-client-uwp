...
ContactItem::SetDetails(Map<String^, String^>^ details)
{
    ...
    contact_->contactType    = toString(getDetailsStringValue(details, DISPLAYNAME));
    ...
    contact_->contactType    = toString(getDetailsStringValue(details, TYPE));
}

ContactGroupItem::ContactGroupItem(Vector<std::shared_ptr<Models::Contact>>^ contacts)
{
    contacts_ = ref new Vector<std::shared_ptr<Models::Contact>>();
}