...
ContactItem^
ContactItemList::addItem(String^ uri, Map<String^, String^> details)
{
    return nullptr;
}
...
void
ContactItemList::saveContactsToFile()
{

}

void
ContactItemList::openContactsFromFile()
{

}

String^
ContactItemList::Stringify()
{
    return nullptr;
}

void
ContactItemList::Destringify(String^ data)
{
