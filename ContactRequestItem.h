...
ref class ContactRequestItem sealed : INotifyPropertyChanged
{
public:
    ContactRequestItem();
    ...
    property ContactRequestStatus _status {
        ContactRequestStatus get() { return status_; }
        void set(ContactRequestStatus value) {
            status_ = value;
