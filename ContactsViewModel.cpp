...
void
ContactsViewModel::saveContactsToFile() // to check with andreas
{
...
void
ContactsViewModel::openContactsFromFile() // to check with andreas
{
    String^ contactsFile = ".profile\\contacts.json";
...
void
ContactsViewModel::Destringify(String^ data) // to check with andreas
{
