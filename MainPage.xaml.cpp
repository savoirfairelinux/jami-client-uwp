...
MainPage::MainPage()
{
    ...
    RingD::instance->setLoadingStatusText += ref new SetLoadingStatusText(this, &MainPage::setLoadingStatusText);
...
void
MainPage::setLoadingStatusText(String^ statusText, String^ color)
{
