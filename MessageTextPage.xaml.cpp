...
MessageTextPage::MessageTextPage()
{
    ...
    {
        if (width <= 729 && width > 638) {
            _contactButtonsGrid_->SetValue(Grid::ColumnSpanProperty, 2);
            _contactButtonsGrid_->SetValue(Grid::ColumnProperty, 0);
            _contactButtonsGrid_->SetValue(Grid::RowProperty, 1);
            _contactButtonsGrid_->Margin = Windows::UI::Xaml::Thickness(18.0, 0.0, 18.0, 6.0);
        }
        else {
            _contactButtonsGrid_->SetValue(Grid::ColumnSpanProperty, 1);
            _contactButtonsGrid_->SetValue(Grid::ColumnProperty, 2);
            _contactButtonsGrid_->SetValue(Grid::RowProperty, 0);
            _contactButtonsGrid_->Margin = Windows::UI::Xaml::Thickness(0.0, 0.0, 18.0, 0.0);
        }
    });
