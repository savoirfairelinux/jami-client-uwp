...
RingD::dequeueTasks()
{
    for (int i = 0; i < tasksList_.size(); i++) {
        ...
        {
            // Problem here when removing a contact after adding then removing then adding ???
            // Also causes a problem when adding a contact after adding then removing adding then removing ???
