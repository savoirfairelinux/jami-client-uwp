    ...
    create_task([&]()
    {
        ...
        std::map<std::string, SharedCallback> outgoingVideoHandlers =
        {
            ...
            ([this](const std::string& device,
                ...
                MSG_("\n<GetCameraInfo>\n");
                auto device_list = Video::VideoManager::instance->captureManager()->deviceList;
                auto device_name_list = Video::VideoManager::instance->captureManager()->deviceNameList;
                ...
                //Capture::MediaCapture^ mc = Video::VideoManager::instance->captureManager()->mediaCapture.Get();
                //auto caps = mc->VideoDeviceController->GetAvailableMediaStreamProperties(Capture::MediaStreamType::VideoPreview);
            }),
