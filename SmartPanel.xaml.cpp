...
SmartPanel::SmartPanel()
{
    ...
    _smartList_->ItemsSource = SmartItemsViewModel::instance->_itemsListFiltered;
    ...
    AccountItemsViewModel::instance->contactItemAdded += ref new ViewModel::ContactItemAdded(
        [this](String^ accountId, String^ uri) {
            ...
            SmartItemsViewModel::instance->addItem(contactItem);
        });
...
RingClientUWP::Views::SmartPanel::updatePageContent()
{
    ...
    SmartItemsViewModel::instance->refreshFilteredItemsList();
