...
SmartPanel::_accountList__SelectionChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::SelectionChangedEventArgs^ e)
{
    ...
    Configuration::UserPreferences::instance->PREF_ACCOUNT_ID = accountItem->_account->accountID_;
...
void RingClientUWP::Views::SmartPanel::OnexportOnRingEnded(Platform::String ^accountId, Platform::String ^pin)
{
    ...
    RingD::instance->hideLoadingOverlay("PIN generated", "#ff00ff00");
}
...
{
    selectMenu(MenuOpen::ACCOUNTS_LIST);
    RingD::instance->showLoadingOverlay("Attempting to add this device...", "#ff00ff00");
...
{
    RingD::instance->hideLoadingOverlay("Generating PIN", "#ff00ff00");
