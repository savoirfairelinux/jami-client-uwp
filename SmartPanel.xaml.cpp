...
SmartPanel::SmartPanel()
{
    ...
    _bannedContactList_->ItemsSource = ContactRequestItemsViewModel::instance->itemsListFiltered;
...
SmartPanel::_accountList__SelectionChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::SelectionChangedEventArgs^ e)
{
    ...
    undoListBoxSelection(listbox, e);
...
void
SmartPanel::_bannedList__SelectionChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::SelectionChangedEventArgs^ e)
{
    // disable deselection from listbox
    safe_cast<ListBox^>(sender)->SelectedItem == -1;
}

void
SmartPanel::undoListBoxSelection(ListBox^ listBox, Windows::UI::Xaml::Controls::SelectionChangedEventArgs^ e)
{
    // disable deselection from listbox
