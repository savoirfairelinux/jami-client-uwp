...
void RingClientUWP::Views::SmartPanel::_RegisterState__Toggled(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    ...
    if (isPublic) {
        ...
        _whatWilHappen_->Text = "People can find you with your username.";
    }
    else {
...
Object^
MessageConfirmationVisibility::Convert(Object ^ value, TypeName targetType, Object ^ parameter, String ^ language)
{
    auto messageTimestamp = static_cast<std::time_t>(value);
    //if (Utils::currentTimestamp() - messageTimestamp > 120)
        return VIS::Visible;
    //return VIS::Collapsed;
}
...
MessageDateTimeString::Convert(Object ^ value, TypeName targetType, Object ^ parameter, String ^ language)
{
    ...
    if (Utils::currentTimestamp() - messageTimestamp > 86400)
        return Utils::dateTimeToString(messageDateTime, "day hour minute");
    if (Utils::currentTimestamp() - messageTimestamp > 60)
