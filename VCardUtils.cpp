...
VCard::parseFromString()
{
    ...
    auto md5_0 = Utils::GetMD5Hash(Utils::toPlatformString(m_mParts[Property::PHOTO]));
    ...
    auto md5_1 = Utils::GetMD5Hash(Utils::toPlatformString(m_mParts[Property::PHOTO]));
    if (md5_0->Length() == md5_1->Length()) {
