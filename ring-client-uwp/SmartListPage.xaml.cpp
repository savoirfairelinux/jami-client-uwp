...
void RingClientUWP::Views::SmartListPage::_togglePaneButton__Click(Object^ sender, RoutedEventArgs^ e)
{
    toggleSmartPan();

    _rowRingTxtBx_->Height = (_rowRingTxtBx_->Height == 0) ? 40 : 0;
    _selectedAccountAvatar_->Height = (_selectedAccountAvatar_->Height == 80) ? 50 : 80;
    _selectedAccountAvatar_->Width = _selectedAccountAvatar_->Height;
    _selectedAccountAvatarColumn_->Width = (_selectedAccountAvatarColumn_->Width == 90) ? 60 : 90;
    _selectedAccountRow_->Height = (_selectedAccountRow_->Height == 90) ? 60 : 90;
